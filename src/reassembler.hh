...
//           bytes_pending_(0),
//           last_idx_(0),
//           last_substring_received_(false),
//           unassembled_() {}

//     void insert(uint64_t first_idx, std::string data, bool is_last_substring);
...
//     uint64_t last_idx_;
//     bool last_substring_received_;
//     std::map<uint64_t, char> unassembled_;
// };
...
private:
  ...
  unordered_map<int,string> buffer_{};
